...
angular.module('spacecraft.lazy.module', []);

angular.module('spacecraft.lazy.module').factory('LazyImgMagic', [
...
angular.module('spacecraft.lazy.module').factory('lazyImgHelpers', [
